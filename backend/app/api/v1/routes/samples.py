...
from backend.app.schemas.leads import SampleCreate, LeadSubmissionResponse
...
@router.post(
    ...
    summary="Submit a Free Product Sample Request",
)
...
async def create_sample_request(
    ...
    is_human = await verify_turnstile_token(sample_in.turnstile_token, remote_ip=client_ip)
    if not is_human:
        raise HTTPException(
    ...
    return service.submit_sample(sample_in)

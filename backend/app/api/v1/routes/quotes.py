...
@router.post(
    ...
    summary="Submit a B2B Bulk Quotation Request",
)
...
async def create_quote_request(
    ...
    is_human = await verify_turnstile_token(quote_in.turnstile_token, remote_ip=client_ip)
    if not is_human:
        raise HTTPException(
    ...
    return service.submit_quote(quote_in)
